...
<div id = "content-table">
    <div class = "content">
        <div class = "title">Управление информационной лентой</div>
        ...
        <? require_once pathTemplate . 'sectionAlert.php' ?> 
            <table>
                ...
                <tr>
                    ...
                    <td><?= $item[2] ?></td>
                    <td> <a onclick = "return confirmDelete()" href = "?action=new&id=<?= $item[0] ?>">Удалить</a> | <a href = "editor.php?id=<?= $item[0] ?>">Редактировать</a> </td>
                </tr>
                <? endforeach; ?>
            </table>
